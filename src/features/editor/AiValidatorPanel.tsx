      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {isValidating && (
          <div className="text-center py-10 flex flex-col items-center">
            ...
            <p className="text-xs text-surface-600 animate-pulse dark:text-surface-400">AI is analyzing circuit topology...</p>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            {validationResult.issues && validationResult.issues.length > 0 && (
              <div className="space-y-2 mt-4">
                <h5 className="text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2 dark:text-surface-400">Detected Issues</h5>
