  ...
  return (
    <div className="p-8 max-w-4xl mx-auto pt-8 pb-20">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
        ...
        <p className="text-surface-400">{t('Manage your profile and preferences')}</p>
      </motion.div>
      ...
      >
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">{displayName || user?.username}</h3>
        ...
        <div className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-surface-300 mb-2">Avatar URL</label>
            <input
              type="url"
              value={avatarUrl}
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between py-3 border-b border-white/5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-surface-300">Username</span>
            </div>
          ...
          <div className="flex items-center justify-between py-3 border-b border-white/5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-surface-300">Role</span>
            </div>
          ...
          <div className="flex items-center justify-between py-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-surface-300">Member since</span>
            </div>
            ...
            return (
              <div key={plan} className={`p-7 rounded-xl border transition-all ${isActive ? 'border-volt-500/40 bg-volt-500/5 shadow-[0_0_15px_rgba(34,197,94,0.1)]' : 'border-white/5 bg-white/[0.02]'}`}>
                ...
                <ul className="space-y-2 mt-3">
                  {features[plan].map((f) => (
                    <li key={f} className="text-xs text-surface-400 flex items-center gap-2">
